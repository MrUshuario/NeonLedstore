...
<p>
NEÓN DESIGN
Actualmente los diseños de neon led se han vuelto una tendencia interesante y diferente para cualquier evento, negocio o para la decoración de tu habitación. En NEON LED STORE realizamos paneles 100% personalizados al estilo de tu marca o para lo que tu evento nececit. Recuerda que puedes cotizar cualquier diseño con nosotros.
</p>
</nav>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 text-center">
         <img src="https://image.shutterstock.com/image-photo/cute-smile-chihuahua-brown-color-600w-1798814425.jpg" width="100" height="100" border="4px solid black " >
         <br>
         <input style="margin-top: 10px" type="button" name="" value="Añadir al carrito ">
         <br><br>
      </div>
          <div class="col-sm-4 text-center">
         <img src="https://i.pinimg.com/564x/20/75/6c/20756c2283956998a947849e7b9a9dc9.jpg" width="100" height="100" border="4px solid black">
         <br>
           <input style="margin-top: 10px" type="button" name="" value="Añadir al carrito ">
         <br><br>
      </div>
           <div class="col-sm-4 text-center">
         <img src="https://i.pinimg.com/564x/80/a3/e9/80a3e9d86a0ba694fa92bf25df822352.jpg" width="100" height="100" border="4px solid black">
         <br>
           <input style="margin-top: 10px" type="button" name="" value="Añadir al carrito ">
         <br><br>
      </div>
      ...
      <div class="col-sm-4 text-center">
         <img src="bulldog.jpg" width="100" height="100" border="4px solid black">
         <br>
           <input style="margin-top: 10px" type="button" name="" value="Añadir al carrito ">
         <br><br>
      </div>
 ...
 <div class="row">
 		<div class="span2">
			...
			<div> <select name="cbx_categoria" id="cbx_categoria "></select></div>
<?php
	require ('../conexion.php');
	
	$id = $_POST['id'];
	
	$query = "SELECT cat_nombre FROM tab_categoria WHERE cat_activo = '1'";
	$resultado=$mysqli->query($query);
	
	while($row = $resultado->fetch_assoc())
	{
		$html.= "<option value='".$row['id']."'>".$row['tab_categoria']."</option>";
	}
	echo $html;
?>
	</body>
