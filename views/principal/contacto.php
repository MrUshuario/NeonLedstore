            ...
            <form id="formContact" method="POST">
                <div class="container">
                    <div class="row text-white mx-1 mx-sm-5 pt-3 mb-2 d-flex justify-content-end">
                        <div class="formulario col-12 col-sm-12 col-lg-5 p-5 border border-white">
                            ...
                            <input class="p-2 input-contact border-0 border-bottom bg-transparent rounded w-100 me-1 me-sm-4 my-3 d-block text-white" type="text" name="pregunta" id="pregunta" placeholder="Mensaje" >
