                    ...
                    <div class="recipient">
                        <div class="contenedor-menuAdmin">
                            ...
                            <ul class="menuAdmin">
                                ...
                                <a href="#"><li class="listaAdmin" onclick="verificacionCorreo()"><i class="fa-solid fa-lock"></i> Verificar Correo</li></a>
                            </ul>                         
                        </div>
                            ...
                            <div class="container" style="display: flex; align-items: center;">
                              ...
                              <div class="row espacio-admin">
                                <div class="col-sm-12 border neontabla">
                                    <button type="submit" class="btn btn-primary" id="save" style="margin-left: 100px; margin-right: 100px; margin-top: 30px; margin-bottom: 30px;">Recibir un correo</button>
                                </div>
                              </div>
                            </div>
                        </div>
