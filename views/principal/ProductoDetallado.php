...
<div class="arreglos">
    ...
    <div class="detalle">
        ...
        <div class="conten">
            <p><label>descripcion del producto</label></p>
        <i class="fa-solid fa-hand-holding-dollar"></i> <label type="text" id="pro_precio">S/ 300</label>
        <!--CONTENIDO-->
        <form class="formMod col-12 col-sm-10">                            
                        ...
                        consequat.</p>
=======
>>>>>>> 7d1a152b25cd428510ec617a9d78c133b739602d
