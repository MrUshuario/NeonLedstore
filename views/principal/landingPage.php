        ...
        <div class="container-fluid text-white text-center">
            <main class="main row pb-5 d-flex justify-content-center">
                ...
                <div class="mainContent col-8 my-5 pb-3">
                    ...
                    <h1 class="mainTitle my-3 fs-2">¿Quieres tener un negocio visualmente atractivo?</h1>
                    <div class="row d-flex justify-content-center">
                        <form class="landingPageForm col-12 col-sm-5" method="POST" action="/build/enviingPage">
                            <div class="">
                                <input type="text" class="textInput text-center form-control my-1 my-sm-5 border-0" name="nombre" placeholder="Nombres y Apellidos" required>
                            </div>
                            <div class="">
                                <input type="email" class="emailInput text-center form-control my-1 my-sm-5 border-0" name="correo" placeholder="Correo Electrónico" required>
                            </div>
                            <div class="">
                                <input type="tel" class="telInput text-center form-control my-1 my-sm-5 border-0" name="telefono" id="telefono" placeholder="Número de celular" required>
                            </div>
                            <button type="submit" class="formButton btn btn-primary my-0 my-sm-3 border-0">Obtén una asesoría perzonalizada GRATIS!</button>
                        </form>
                    </div>
                </div>
            </main>
