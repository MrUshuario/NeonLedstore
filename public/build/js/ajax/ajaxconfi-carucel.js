    ...
    function cambiarEvento(){
        ...
        if (imgCar=="img1") {
            imagen.src="/build/img/landingPage/lp-evento/e2.jpg";
            
            imagen2.src="/build/img/landingPage/lp-evento/e3.jpg";

            imagen3.src="/build/img/landingPage/lp-evento/e1.jpg";
            
            imgCar="img2";
            
        } else if(imgCar=="img2"){
            imagen.src="/build/img/landingPage/lp-evento/e3.jpg";

            imagen2.src="/build/img/landingPage/lp-evento/e1.jpg";
    ...
    function cambiarHogar(){
        ...
        if (clickHogar=="img1") {
            ...
            imagen2.src="/build/img/landingPage/lp-hogar/h3.jpg";
            ...
            imagen.src="/build/img/landingPage/lp-hogar/h3.jpg";

            imagen2.src="/build/img/landingPage/lp-hogar/h1.jpg";

            imagen3.src="/build/img/landingPage/lp-hogar/h2.jpg";
    ...
    function cambiarNegocio(){
        ...
        if (clickNegocio=="img1") {
            imagen.src="/build/img/landingPage/lp-negocio/git";
            
            imagen2.src="/build/img/landingPage/lp-negocio/n3.jpg";

            imagen3.src="/build/img/landingPage/lp-negocio/n1.jpg";
            
            clickNegocio="img2";
        } else if(clickNegocio=="img2"){
            imagen.src="/build/img/landingPage/lp-negocio/n3.jpg";

            imagen2.src="/build/img/landingPage/lp-negocio/colorblanco.jpg";
            ...
            imagen3.src="/build/img/landingPage/lp-negocio/colorblanco.jpg";
